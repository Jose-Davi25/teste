...
<body>
    <div class="topo">
        <a href="5pagina-Produtos_Cadastrados.php"><i class='bx bx-left-arrow-circle'></i>Voltar</a><br><br>
        <h1>Clientes cadastrados</h1>
        <a href="../../html/3pagina-Cadastro_Clientes.html" class="novoC">Adicionar novo cliente</a>
    </div>
    <?php
    if ($Cliente->num_rows == 0)
        echo "<p>Não existem Cliente cadastrados</p>";
    else {
        ?>
        <table border="1">
            <thead>
            ...
            <tbody>
                ...
                while ($dados = $Cliente->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="7pagina-Editar_Cliente.php?ID_Cliente=<?php echo $dados['ID_Cliente']; ?>"><i
                                    class='bx bx-edit'></i></a>
                            <a href="6pagina-Excluir_Cliente.php?ID_Cliente=<?php echo $dados['ID_Cliente']; ?>"><i
